...
abstract contract BaseStrategy {
    /// Temporary storage to know the caller
    ...
    function tstorereceiver(address _receiver) public {
        RECEIVER = _receiver;
    }
     ...
     */
    function availableDepositLimit(address /*_owner*/ ) public virtual returns (uint256) {
     ...
     */
    function availableWithdrawLimit(address /*_owner*/ ) public virtual returns (uint256) {
        return type(uint256).max;
    }
